...
class LSTMCONV(nn.Module):
    ...
    def forward(self, origin_input):
        ...
        mask0 = torch.ones(batch_size, 1, row, col).cuda() / 2.
...
class MSRN_ATT(nn.Module):
    ...
    #def __init__(self, conv= common.default_conv):
        ...
        # define head module
        modules_head = [conv(4, n_feats, kernel_size)] # here we input image + guidance map
        # define body module
    ...
    def forward(self, x):
        ...
        #print("----------0", x.shape, mask.shape)  # [32, 3, 256, 256]        
