...
class SRData(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # produce from lr 0.299 R + 0.587 G + 0.114 B 
        R = lr_tensor[0]
        G = lr_tensor[1]
        B = lr_tensor[2]
        lr_gray=0.299*R+0.587*G+0.114*B        
        lr_gray = lr_gray.view(1,lr_tensor.shape[1],lr_tensor.shape[2])

        return lr_tensor, lr_gray, hr_tensor, filename
